define(['three', 'planet/faceMesh', 'planet/chunkVisibilityTest', 'planet/lodSystem', 'planet/heightmapManager'],
    function(THREE, FaceMesh, visibilityTest, LOD, heightmapManager) {
